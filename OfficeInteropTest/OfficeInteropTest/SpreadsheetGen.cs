...
namespace GeneratedCode
{
    public class GeneratedClass
    {
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            X15ac.AbsolutePath absolutePath1 = new X15ac.AbsolutePath() { Url = "C:\\Users\\Ltcol\\Documents\\" };
            ...
            WorkbookView workbookView1 = new WorkbookView() { XWindow = 0, YWindow = 0, WindowWidth = (UInt32Value)28800U, WindowHeight = (UInt32Value)14235U };
            ...
            CalculationProperties calculationProperties1 = new CalculationProperties() { CalculationId = (UInt32Value)0U, FullCalculationOnLoad = true };
        ...
        private void GenerateWorksheetPart1Content(WorksheetPart worksheetPart1)
        {
            ...
            SheetFormatProperties sheetFormatProperties1 = new SheetFormatProperties() { DefaultRowHeight = 14.25D, DyDescent = 0.2D };

            Columns columns1 = new Columns();
            Column column1 = new Column() { Min = (UInt32Value)1U, Max = (UInt32Value)1U, Width = 10.75D, CustomWidth = true };

            columns1.Append(column1);
            SheetData sheetData1 = new SheetData();
            PageMargins pageMargins1 = new PageMargins() { Left = 0D, Right = 0D, Top = 0.39409448818897641D, Bottom = 0.39409448818897641D, Header = 0D, Footer = 0D };

            HeaderFooter headerFooter1 = new HeaderFooter();
            OddHeader oddHeader1 = new OddHeader();
            oddHeader1.Text = "&C&A";
            OddFooter oddFooter1 = new OddFooter();
            oddFooter1.Text = "&CPage &P";
        ...
        private void GenerateWorksheetPart2Content(WorksheetPart worksheetPart2)
        {
            ...
            SheetFormatProperties sheetFormatProperties2 = new SheetFormatProperties() { DefaultRowHeight = 14.25D, DyDescent = 0.2D };

            Columns columns2 = new Columns();
            Column column2 = new Column() { Min = (UInt32Value)1U, Max = (UInt32Value)1U, Width = 10.75D, CustomWidth = true };

            columns2.Append(column2);
            SheetData sheetData2 = new SheetData();
            PageMargins pageMargins2 = new PageMargins() { Left = 0D, Right = 0D, Top = 0.39409448818897641D, Bottom = 0.39409448818897641D, Header = 0D, Footer = 0D };

            HeaderFooter headerFooter2 = new HeaderFooter();
            OddHeader oddHeader2 = new OddHeader();
            oddHeader2.Text = "&C&A";
            OddFooter oddFooter2 = new OddFooter();
            oddFooter2.Text = "&CPage &P";
        ...
        private void GenerateWorksheetPart3Content(WorksheetPart worksheetPart3)
        {
            ...
            SheetFormatProperties sheetFormatProperties3 = new SheetFormatProperties() { DefaultRowHeight = 14.25D, DyDescent = 0.2D };

            Columns columns3 = new Columns();
            Column column3 = new Column() { Min = (UInt32Value)1U, Max = (UInt32Value)2U, Width = 10.75D, CustomWidth = true };

            columns3.Append(column3);

            SheetData sheetData3 = new SheetData();

            #region old rows init
            //Row row1 = new Row() { RowIndex = (UInt32Value)1U, Spans = new ListValue<StringValue>() { InnerText = "1:2" }, DyDescent = 0.2D };
            ...
            //Row row2 = new Row() { RowIndex = (UInt32Value)2U, Spans = new ListValue<StringValue>() { InnerText = "1:2" }, DyDescent = 0.2D };
            ...
            //Row row3 = new Row() { RowIndex = (UInt32Value)3U, Spans = new ListValue<StringValue>() { InnerText = "1:2" }, DyDescent = 0.2D };
            ...
            //Row row4 = new Row() { RowIndex = (UInt32Value)4U, Spans = new ListValue<StringValue>() { InnerText = "1:2" }, DyDescent = 0.2D };
            ...
            //Row row5 = new Row() { RowIndex = (UInt32Value)5U, Spans = new ListValue<StringValue>() { InnerText = "1:2" }, DyDescent = 0.2D };

            //Cell cell9 = new Cell() { CellReference = "A5" };
            //CellValue cellValue9 = new CellValue();
            //cellValue9.Text = "4";

            //cell9.Append(cellValue9);

            //Cell cell10 = new Cell() { CellReference = "B5" };
            //CellValue cellValue10 = new CellValue();
            //cellValue10.Text = "34.9";
            ...
            PageMargins pageMargins3 = new PageMargins() { Left = 0D, Right = 0D, Top = 0.39409448818897641D, Bottom = 0.39409448818897641D, Header = 0D, Footer = 0D };

            HeaderFooter headerFooter3 = new HeaderFooter();
            OddHeader oddHeader3 = new OddHeader();
            oddHeader3.Text = "&C&A";
            OddFooter oddFooter3 = new OddFooter();
            oddFooter3.Text = "&CPage &P";
        ...
        #endregion
        private OpenXmlElement[] GetRowsFromModel(List<Article> articles)
        {
            List<Row> rowsFromModel = new List<Row>(); //list of rows for the excel sheet
            AlphabetProvider ap = new AlphabetProvider();
            List<char> alphabet = new List<char>(ap.GetAlphabet()); //list for the column letters

            List<string> memberProperties = GetPropertiesForModel<Article>(articles); //get property names for the Article type
            
            rowsFromModel.Add(GetHeaders(articles)); //add the header row
            int rowIndex = 2;
            foreach (var item in articles)
            {
                ...
                foreach (var p in memberProperties)
                {
                    //each prop needs a cell
                    string cellRef = alphabet[columnIndex].ToString() + rowIndex.ToString();
                    Cell c = new Cell();
                    c.CellReference = cellRef;
                    CellValue cv = new CellValue();
                    if (p == "ArticleId")
                    {
                        cv.Text = "#" + GetPropValue(item, p).ToString(); //excel was having a problem reading these values (which are MD5 hashes) so adding a '#' in front so they appear in the sheet
                    }
                    else
                    {
                        //Article contains ICollection properties (linked tables) so just putting text in these cells rather than '[System.Collections.Generic...etc]'
                        cv.Text = GetPropValue(item, p).GetType().Namespace == "System.Collections.Generic" ? "Collection of " + p : GetPropValue(item, p).ToString();
                    }
                    
                    c.Append(cv); //attach value to cell
                    r.Append(c); //attach cell to row
                    columnIndex++;
                }
                rowsFromModel.Add(r);
                rowIndex++;
            }
            return rowsFromModel.ToArray();
        }

        //returns one row containing the headers for the sheet (ArticleId, ArticleText etc) 
        private Row GetHeaders(List<Article> articles)
        {
            List<string> headers = GetPropertiesForModel<Article>(articles);
            AlphabetProvider ap = new AlphabetProvider();
            ...
            {
                string cellRef = alphabet[columnIndex].ToString() + "1";
                Cell c = new Cell();
                c.CellReference = cellRef;
                CellValue cv = new CellValue();
                cv.Text = item;
        ...
        private List<string> GetPropertiesForModel<T>(List<T> l)
        {
            List<string> properties = new List<string>();
            MemberInfo[] memberInfoList = l[0].GetType().GetMembers();
            
            foreach (var item in memberInfoList)
            {
                if (item.MemberType == MemberTypes.Property) //only want properties (not methods)
                {
        ...
        {
            SharedStringTable sharedStringTable1 = new SharedStringTable() { Count = (UInt32Value)2U, UniqueCount = (UInt32Value)2U };
        ...
        private void GenerateWorkbookStylesPart1Content(WorkbookStylesPart workbookStylesPart1)
        {
            ...
            NumberingFormat numberingFormat1 = new NumberingFormat() { NumberFormatId = (UInt32Value)164U, FormatCode = "[$£-809]#,##0.00;[Red]\"-\"[$£-809]#,##0.00" };
            ...
            Alignment alignment2 = new Alignment() { Horizontal = HorizontalAlignmentValues.Center, TextRotation = (UInt32Value)90U };

            cellFormat3.Append(alignment2);
            CellFormat cellFormat4 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)2U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U };
            CellFormat cellFormat5 = new CellFormat() { NumberFormatId = (UInt32Value)164U, FontId = (UInt32Value)2U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U };
            ...
            CellStyle cellStyle1 = new CellStyle() { Name = "Heading", FormatId = (UInt32Value)1U };
            CellStyle cellStyle2 = new CellStyle() { Name = "Heading1", FormatId = (UInt32Value)2U };
            CellStyle cellStyle3 = new CellStyle() { Name = "Normal", FormatId = (UInt32Value)0U, BuiltinId = (UInt32Value)0U, CustomBuiltin = true };
            CellStyle cellStyle4 = new CellStyle() { Name = "Result", FormatId = (UInt32Value)3U };
            CellStyle cellStyle5 = new CellStyle() { Name = "Result2", FormatId = (UInt32Value)4U };
        ...
        {
            document.PackageProperties.Creator = "Ltcol Ki1gore";
            document.PackageProperties.Revision = "1";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2013-05-15T13:56:09Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2013-05-15T15:50:02Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Ltcol Ki1gore";
        }
